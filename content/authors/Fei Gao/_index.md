...
bio: My research interests include aerial robotics, autonomous navigation, swarm cooperation, and embodied intelligence.

interests:
  - Planning, Mapping, Estimation
  - Swarm Robotics
  - Robot Learning
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'fgaoaa@zju.edu.cn'
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=4RObDv0AAAAJ&hl=en&oi=ao
